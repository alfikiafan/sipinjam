...
<section class="min-vh-100 mb-4">
  <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('{{ asset('assets/img/curved-images/register.png') }}');">
    <span class="mask bg-gradient-dark opacity-6"></span>
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-5 text-center mx-auto">
          <h1 class="text-white mb-2 mt-5" id="register-heading">Sipinjam</h1>
          <p class="text-lead text-white" id="register-description">Buat akun untuk mengajukan borroweran barang secara online, mudah, dan aman.</p>
        </div>
      </div>
    </div>
  </div>
            ...
            <form role="form text-left" method="POST" action="/register">
              ...
              <div class="form-check form-check-info text-left">
                ...
                <label class="form-check-label" for="flexCheckDefault">
                  I agree with <a href="javascript:;" class="text-dark font-weight-bolder" data-bs-toggle="modal" data-bs-target="#terms-and-conditions">Terms and Conditions</a>
                </label>
                @error('agreement')
