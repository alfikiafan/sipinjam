    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('categories') ? 'active' : '') }}" href="{{ url('categories') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-alt ps-2 pe-2 text-center text-dark {{ (Request::is('categories') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1 {{ (Request::is('categories') ? 'text-dark' : 'text-white') }}">Categories</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('unitadmins') ? 'active' : '') }}" href="{{ url('unitadmins') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-user-cog ps-2 pe-2 text-center text-dark {{ (Request::is('unitadmins') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1 {{ (Request::is('unitadmins') ? 'text-dark' : 'text-white') }}">Unit Admins</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('units') ? 'active' : '') }}" href="{{ url('units') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-building ps-2 pe-2 text-center text-dark {{ (Request::is('units') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('bookings') ? 'active' : '') }}" href="{{ url('bookings') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-calendar-alt ps-2 pe-2 text-center text-dark {{ (Request::is('bookings') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1 {{ (Request::is('bookings') ? 'text-dark' : 'text-white') }}">Bookings</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('items') ? 'active' : '') }}" href="{{ url('items') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-cubes ps-2 pe-2 text-center text-dark {{ (Request::is('items') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1 {{ (Request::is('items') ? 'text-dark' : 'text-white') }}">Items</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('bookings') ? 'active' : '') }} " href="{{ url('bookings') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-lg fa-calendar-check ps-2 pe-2 text-center text-dark {{ (Request::is('bookings') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1 {{ (Request::is('bookings') ? 'text-dark' : 'text-white') }}">Bookings</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('items') ? 'active' : '') }}" href="{{ url('items') }}">
          ...
          <span class="nav-link-text ms-1 {{ (Request::is('items') ? 'text-dark' : 'text-white') }}">Items Available</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('profile') ? 'active' : '') }}" href="{{ url('profile') }}">
